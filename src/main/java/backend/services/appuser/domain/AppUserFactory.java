...
public class AppUserFactory {
    ...
    public AppUser create(String lastName, String stringBirthDate, String email, String phone,
                          String address, String firstName, String password) throws Exception {
        ...
        return new AppUser(firstName, lastName, birthDate, email, phone, address, id, encodedPassword);
    }
